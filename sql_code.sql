CREATE DATABASE IF NOT EXISTS payroll_db_tmp;
USE payroll_db_tmp;
...
CREATE TABLE Employee(
  ...
  ,retirement_amount      DECIMAL(10,2)  NOT NULL DEFAULT 0
...
IF pre_tax_var = TRUE THEN
    ...
    SET e.retirement_amount = e.retirement_amount - IFNULL((gross_pay_var * r.percent/100),0)
    WHERE e.emp_ID = emp_ID;
ELSE
    UPDATE Employee e JOIN Retirement r ON e.r_plan = r.r_plan
    SET e.retirement_amount = e.retirement_amount - IFNULL(((gross_pay_var-tax_sum) * r.percent/100),0)
    WHERE e.emp_ID = emp_ID;
END IF;
...
BEGIN
	...
	UPDATE employee e
	SET e.retirement_amount = IFNULL(e.retirement_amount,0) + IFNULL(retirement_deduction,0)
...
BEGIN
	...
	IF old_pre_tax_var = TRUE THEN
		UPDATE Employee e JOIN Retirement r ON e.r_plan = r.r_plan
		SET e.retirement_amount = IFNULL(e.retirement_amount,0) - IFNULL((old_gross_pay_var * r.percent/100),0)
		WHERE e.emp_ID = old.emp_ID;
	ELSE
		UPDATE Employee e JOIN Retirement r ON e.r_plan = r.r_plan
		SET e.retirement_amount = IFNULL(e.retirement_amount,0) - IFNULL(((old_gross_pay_var-old_tax_sum_var) * r.percent/100),0)
		WHERE e.emp_ID = old.emp_ID;
	END IF;
...
-- Employee ---------------------------------------------------
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('1','Michael West','Male',56,'alexamartinez@example.com','2023-02-19','4938966574',FALSE,'2363635846','Truist Financial','Savings','NA','CEO','HL','Roth 401(k) post-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('2','Samuel Monroe','Male',30,'ggoodman@example.net','2023-02-25','4778016973',TRUE,'4122782825','PNC Bank','Checking','F08','DS','AS1','Simplified Employee Pension Plan',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('3','Timothy Harris','Male',28,'debbieellis@example.org','2023-01-18','6597837495',TRUE,'8466111803','Santander','Savings','F08','DS','AS1','403 (b)',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('4','Cassandra Boyd','Female',32,'raykimberly@example.com','2023-03-09','1564985269',TRUE,'7944732371','Goldman Sachs','Savings','IT02','DS','AS1','Simplified Employee Pension Plan',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('5','Timothy Melendez','Male',33,'stephen77@example.net','2023-03-18','5406999328',TRUE,'9931278947','Capital One','Savings','O56','HRA','AS1','Traditional IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('6','Ms. Brandi Jones','Female',26,'amberpreston@example.com','2023-02-01','2606143397',FALSE,'8954835349','Capital One','Checking','LL01','RC','AS1','Traditional 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('7','Lacey Navarro','Female',27,'elliottderrick@example.com','2023-02-14','1703457120',FALSE,'1971835392','Wells Fargo','Savings','SL65','SC','AS1','Simplified Employee Pension Plan',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('8','Benjamin Hudson','Male',33,'phillipsanthony@example.org','2023-03-15','9376036819',TRUE,'1878587567','Santander','Checking','M87','DA','AS2','Roth IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('9','Laura Santana','Female',32,'mary05@example.org','2023-03-09','8249315123',TRUE,'9017737153','Citi Bank','Checking','F08','RC','AS2','Traditional IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('10','Earla Price','Female',33,'howelldawn@example.net','2023-03-06','4333816842',TRUE,'8835431320','PNC Bank','Checking','LL01','LC','AS2','Roth 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('11','Katelyn Flynn','Female',31,'jacksonstephanie@example.com','2023-01-13','3236170837',TRUE,'7234615717','Chase Bank','Savings','LL01','LC','AS2','Roth IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('12','Lori Harris','Female',30,'corey56@example.org','2023-03-25','9758519013',TRUE,'5134302513','Citi Bank','Checking','SL65','SE','AS2','Roth 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('13','James Garcia','Male',24,'cynthiaestrada@example.com','2023-01-28','8849572476',FALSE,'2981470996','Wells Fargo','Checking','H01','ACC','EL','Roth IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('14','Kimberly Tapin','Female',25,'perrythomas@example.org','2023-03-25','4881257367',FALSE,'8069952132','Bank of America','Savings','CS78','CS','EL','Roth IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('15','Christopher Donovan','Male',24,'allencatherine@example.com','2023-03-02','5876105046',FALSE,'7071190983','Capital One','Savings','CS78','CS','EL','Roth 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('16','Jose Bradley','Male',52,'emilypatterson@example.com','2023-02-28','4847409832',TRUE,'9085484017','Bank of America','Checking','LL01','DI','HL','Simplified Employee Pension Plan',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('17','Tommy Wong','Male',51,'trevorsanders@example.org','2023-02-14','4420882289',TRUE,'1530618370','Bank of America','Checking','O56','DI','HL','Traditional IRA post-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('18','Laura Gentry','Female',55,'michaelroberts@example.org','2023-01-08','9956323416',TRUE,'8332707996','Truist Financial','Savings','SL65','DI','HL','Traditional 401(k) post-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('19','Matthew Chambers','Male',53,'angelajackson@example.net','2023-03-12','7658684887',TRUE,'4705150091','Santander','Savings','LL01','EE','HL','Roth IRA post-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('20','Timothy Jackson','Male',45,'ybrown@example.net','2023-02-01','5515344181',TRUE,'6618084394','Capital One','Checking','M87','EE','HL','Simplified Employee Pension Plan',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('21','Amanda Smith','Female',54,'jcraig@example.com','2023-02-01','1871241447',TRUE,'2087103368','Capital One','Checking','LL01','VI','HL','Roth IRA post-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('22','Matthew Lawson','Male',56,'hosborne@example.org','2023-03-05','9614632998',TRUE,'9086147474','Citi Bank','Savings','RD65','VI','HL','Roth 401(k) post-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('23','Jessica Ford','Female',54,'bbyrd@example.net','2023-03-13','7243759249',FALSE,'2897840239','Goldman Sachs','Savings','M87','VI','HL','Traditional IRA post-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('24','Mark Vasquez','Male',53,'andersonkatie@example.org','2023-02-25','1891796718',TRUE,'1793881710','Chase Bank','Checking','IT02','VI','HL','Traditional 401(k) post-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('25','Michael Crawford','Male',21,'andrea33@example.net','2023-03-24','9729229346',FALSE,'7886058634','PNC Bank','Savings','LL01','ACC','IN','Not Applicable',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('26','Kristie Ford','Female',22,'olsonjohn@example.com','2023-01-02','5762636174',FALSE,'5268060108','Santander','Checking','O56','DS','IN','Not Applicable',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('27','Daniel Davis','Male',21,'millerkevin@example.org','2023-01-06','9445165272',FALSE,'1153931824','U.S. Bank','Checking','SL65','FA','IN','Not Applicable',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('28','Jennifer Hansen','Female',51,'andrew03@example.com','2023-01-15','9149828351',TRUE,'4523010269','Wells Fargo','Savings','RD65','DI','HL','Roth IRA post-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('29','Audrey Melton','Female',22,'gomezjustin@example.com','2023-01-13','3022142957',FALSE,'8986096303','PNC Bank','Checking','F08','RC','IN','Not Applicable',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('30','Edward Contreras','Male',23,'tuckerpamela@example.org','2023-01-25','3988564933',FALSE,'3628750833','Bank of America','Savings','RD65','OA','IN','Not Applicable',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('31','Daniel Miller','Male',25,'katherinesheppard@example.net','2023-03-22','8330674428',FALSE,'8936231850','U.S. Bank','Checking','F08','BA','JU','Traditional 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('32','Emily Ortega','Female',25,'nicholsonerica@example.com','2023-01-07','7432749100',FALSE,'4470249239','Goldman Sachs','Savings','LL01','RC','JU','Roth IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('33','Robin Roberts','Female',26,'alexandria91@example.net','2023-03-26','5205879645',FALSE,'1006789986','Chase Bank','Checking','IT02','TES','JU','Roth IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('34','Ryan Wilson','Male',25,'wardshawn@example.net','2023-03-23','7075798574',FALSE,'5490354768','PNC Bank','Savings','A51','OA','JU','Roth 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('35','Darlene Peterson','Female',26,'wanderson@example.net','2023-01-19','3751434706',FALSE,'8258568023','U.S. Bank','Savings','M87','SC','JU','Traditional IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('36','Emily Ross','Female',30,'andrewbarnes@example.net','2023-03-18','7657171838',TRUE,'4294379963','Bank of America','Checking','F08','BA','LE','Traditional IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('37','Robert Conway','Male',29,'david40@example.net','2023-03-21','5123653209',FALSE,'4573596487','Citi Bank','Checking','CS78','CS','LE','Roth IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('38','Kenneth Holmes','Male',31,'allisonjohnson@example.net','2023-02-05','9742656117',TRUE,'5878025845','Santander','Checking','IT02','GD','LE','Roth IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('39','Elizabeth Zimmerman','Female',56,'james34@example.com','2023-01-18','8791786307',TRUE,'7532959755','Goldman Sachs','Checking','IT02','DI','HL','Roth IRA post-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('40','William Cunningham','Male',56,'jenniferbautista@example.org','2023-02-03','8239138603',FALSE,'2518681304','Santander','Checking','M87','DI','HL','Simplified Employee Pension Plan',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('41','Nicole Flores','Female',32,'aimeekelly@example.net','2023-02-19','7896382125',TRUE,'8979273911','Chase Bank','Checking','CS78','RC','LE','Simplified Employee Pension Plan',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('42','Bob Garcia','Female',31,'sweeneydavid@example.org','2023-02-03','5667760951',TRUE,'4766895640','PNC Bank','Checking','M87','OA','LE','Roth 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('43','Debra Smith','Female',29,'boyletimothy@example.net','2023-01-22','2298447203',TRUE,'5776996939','Chase Bank','Savings','RD65','RE','LE','Traditional 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('44','Tasha Burns','Female',35,'leblancbonnie@example.org','2023-02-07','3147716902',FALSE,'6111920251','Capital One','Checking','H01','HRA','MA','Roth 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('45','Joseph Bradley','Male',52,'michael89@example.org','2023-01-22','4744348135',TRUE,'1570015858','Chase Bank','Checking','IT02','EE','HL','Traditional 401(k) post-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('46','Daniel Hogan','Male',49,'kelly50@example.com','2023-02-03','3243454164',TRUE,'5312619071','Chase Bank','Savings','A51','DI','HL','Roth 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('47','Omar Ferguson','Male',49,'jimenezcalvin@example.net','2023-03-10','1198168828',TRUE,'2342094845','Goldman Sachs','Checking','F08','DI','HL','Roth 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('48','Manuel Johnson','Male',46,'jcastillo@example.net','2023-02-02','2378170698',TRUE,'6121944541','U.S. Bank','Checking','CS78','RC','SP','Traditional IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('49','Christopher Thomas','Male',38,'amanda27@example.com','2023-02-11','3882455823',TRUE,'2171040915','Santander','Checking','CS78','RC','SP','Roth 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('50','Stephen Bradley','Male',37,'castillofrank@example.net','2023-02-05','3207873733',FALSE,'6662849574','Santander','Checking','A51','OA','SP','Roth IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('51','James Espinoza','Male',26,'veronica58@example.com','2023-02-18','1735620429',FALSE,'9127122242','Truist Financial','Checking','RD65','RE','JU','Traditional 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('52','Derrick Torres','Male',23,'ahall@example.com','2023-01-26','1558663601',FALSE,'3901232981','Bank of America','Checking','LL01','RC','AS1','Not Applicable',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('53','Samantha Wilson','Female',58,'karenesparza@example.org','2023-02-04','5664848084',TRUE,'2683269674','Goldman Sachs','Checking','O56','EE','HL','Traditional 401(k) post-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('54','Kristie Benson','Female',34,'samuelruiz@example.com','2023-01-15','6636889684',TRUE,'4510886562','Truist Financial','Savings','SL65','MRA','LE','Roth IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('55','Maria Sullivan','Female',54,'xfarley@example.net','2023-03-17','3438636480',TRUE,'8295428906','Bank of America','Checking','CS78','DI','HL','Simplified Employee Pension Plan',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('56','Kevina Reed','Female',21,'lisahoward@example.com','2023-03-10','7293830307',FALSE,'1961189885','Goldman Sachs','Checking','H01','HRB','IN','Not Applicable',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('57','Andrea Smith','Female',35,'swalker@example.com','2023-02-01','2683957564',TRUE,'8151896308','PNC Bank','Checking','O56','DS','LE','Traditional IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('58','Laura Flores','Female',44,'michael18@example.com','2023-03-25','1129983470',FALSE,'3041545544','PNC Bank','Checking','RD65','GD','SP','Traditional 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('59','Lisa Torres','Female',39,'michellejoseph@example.com','2023-02-10','4632538452',FALSE,'3468224333','Truist Financial','Savings','IT02','HRB','SE','Traditional 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('60','Glen Silva','Male',27,'nicole99@example.org','2023-01-31','4422048585',FALSE,'3789372578','U.S. Bank','Checking','A51','SC','JU','Traditional IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('61','Edward Vasquez','Male',45,'nwright@example.com','2023-03-12','7831299927',TRUE,'7366750668','Bank of America','Checking','O56','VI','HL','Traditional 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('62','David Gardner','Male',22,'fray@example.com','2023-01-25','7833164976',FALSE,'8676510043','Truist Financial','Savings','H01','HRB','IN','Not Applicable',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('63','Jessica Evans','Female',31,'vtaylor@example.net','2023-01-03','9924488511',TRUE,'3090061251','Goldman Sachs','Checking','O56','BA','LE','Traditional IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('64','Carla Joseph','Female',33,'perezsusan@example.com','2023-03-04','3384083537',FALSE,'8825529426','Santander','Checking','O56','OA','AS2','Traditional IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('65','Kevin Hutchinson','Male',46,'craigclements@example.org','2023-02-17','9888897104',FALSE,'6922377726','Capital One','Savings','O56','CS','SE','Traditional 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('66','Allen Gay','Male',43,'andrewssonya@example.net','2023-03-17','4478233603',TRUE,'4251624056','Santander','Checking','SL65','DS','SE','Roth 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('67','Laura Snow','Female',37,'kjones@example.com','2023-02-07','7777163837',TRUE,'1840381733','PNC Bank','Checking','RD65','FA','MA','Traditional 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('68','Donald Morris','Male',28,'sandra00@example.net','2023-03-01','9317962158',TRUE,'9225368829','Bank of America','Savings','RD65','RC','AS1','403 (b)',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('69','Nathan Graham','Male',29,'wilsonemma@example.com','2023-01-11','4640572126',TRUE,'8956449152','Chase Bank','Checking','IT02','RC','AS1','Traditional IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('70','Gabriel Fleming','Male',23,'melissa05@example.org','2023-03-17','9593556607',FALSE,'9498435585','Bank of America','Checking','IT02','CS','IN','Not Applicable',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('71','Robert Sanchez','Male',41,'uallen@example.org','2023-01-03','6305320432',FALSE,'6939036170','Wells Fargo','Checking','O56','DS','SP','Traditional IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('72','Jennifer Harper','Female',49,'sandra42@example.net','2023-02-19','3845362401',TRUE,'3039557201','Citi Bank','Checking','SL65','VI','HL','Roth IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('73','April Williams','Female',42,'davischeyenne@example.com','2023-03-04','8902579565',TRUE,'5957540284','Santander','Savings','H01','RC','SE','Roth IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('74','Tara Walker','Female',40,'zacharycarrillo@example.com','2023-03-08','9898081286',TRUE,'1067464491','Capital One','Checking','A51','OA','SP','Roth IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('75','Scott Anderson','Male',24,'ashleyjones@example.com','2023-02-08','1363626724',FALSE,'6067191149','Truist Financial','Checking','RD65','ACC','JU','Traditional 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('76','Andrew Floyd','Male',26,'watersjennifer@example.com','2023-03-03','6947304439',FALSE,'1969549862','Wells Fargo','Savings','F08','BA','EL','Roth IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('77','Jesse Gay','Male',25,'davidwells@example.com','2023-01-13','7449876106',FALSE,'2576124271','Chase Bank','Checking','M87','MRA','JU','Traditional IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('78','Michael Marquez','Male',32,'veronicaturner@example.com','2023-01-09','3965663196',TRUE,'8640187694','Capital One','Savings','IT02','DS','AS2','Traditional 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('79','Jonathan Salazar','Male',52,'yburke@example.org','2023-02-03','6348227727',FALSE,'3872118270','Truist Financial','Checking','H01','DI','HL','Traditional 401(k) post-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('80','Kelsey Hughes','Female',55,'georgegill@example.org','2023-03-29','9175836491',TRUE,'5341281639','Capital One','Checking','A51','VI','HL','Traditional 401(k) post-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('81','Donna Norman','Female',55,'uhughes@example.org','2023-02-23','7103217717',TRUE,'8723309920','U.S. Bank','Savings','A51','EE','HL','Roth IRA post-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('82','Christopher Morton','Male',30,'christophersnow@example.net','2023-03-25','2118594780',FALSE,'7997790446','Goldman Sachs','Savings','SL65','HRB','AS1','Roth IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('83','Nicole Moss','Male',51,'pamela02@example.org','2023-03-04','5412211686',TRUE,'3082029167','Santander','Savings','RD65','EE','HL','Traditional 401(k) post-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('84','Spencer Woodward','Male',31,'jacksonwalter@example.com','2023-01-23','2082550715',TRUE,'7939798543','U.S. Bank','Checking','CS78','HRA','AS2','Traditional 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('85','Mr. Larry Wade DDS','Male',58,'heatherreyes@example.org','2023-02-14','4184414029',TRUE,'3593393772','Goldman Sachs','Savings','F08','VI','HL','Roth 401(k) post-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('86','Brandy Elliott MD','Female',54,'wendy50@example.net','2023-03-06','6048301832',TRUE,'6309420888','Santander','Savings','SL65','EE','HL','Roth IRA post-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('87','Alexander Rivera','Male',55,'fsimmons@example.org','2023-01-30','5226555608',TRUE,'5154717862','Goldman Sachs','Savings','CS78','EE','HL','Roth 401(k) post-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('88','Kyle Padilla','Female',55,'xbenson@example.com','2023-01-07','2645689727',FALSE,'8132511708','Santander','Savings','CS78','VI','HL','Roth 401(k) post-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('89','David Allen','Male',53,'ruizamy@example.net','2023-01-31','9823262051',TRUE,'4519858899','Chase Bank','Savings','H01','VI','HL','Simplified Employee Pension Plan',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('90','Johnathan Green','Male',48,'dudleysandra@example.com','2023-02-02','7007563175',TRUE,'6589329268','Truist Financial','Savings','H01','EE','HL','Traditional 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('91','Julie Sexton','Female',39,'arthur98@example.org','2023-03-09','6970307272',TRUE,'2127966460','Truist Financial','Checking','CS78','CS','MA','Simplified Employee Pension Plan',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('92','Nicole Anderson','Female',41,'meaganwilliams@example.com','2023-02-20','8719383556',FALSE,'5105433614','Bank of America','Checking','RD65','GD','SP','Traditional 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('93','Shawn Franco','Male',22,'arogers@example.org','2023-01-31','6465734977',FALSE,'6456009141','Bank of America','Checking','IT02','DA','IN','Not Applicable',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('94','Laurie Johnson','Female',23,'hector16@example.net','2023-02-24','4309260670',FALSE,'7528145504','Santander','Checking','O56','CS','IN','Not Applicable',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('95','Charles Hawkins','Male',45,'christopher31@example.net','2023-03-14','3889662004',TRUE,'4572079205','Chase Bank','Checking','F08','EE','HL','Traditional IRA pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('96','Stephen Zhang','Male',32,'joemaldonado@example.net','2023-03-15','3255992861',TRUE,'8239165449','PNC Bank','Savings','SL65','HRB','LE','Traditional 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('97','Julie Delgado','Female',27,'hward@example.net','2023-01-18','2081885552',FALSE,'1146208285','Goldman Sachs','Savings','O56','DS','AS1','Roth 401(k) pre-50',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('98','Paul Munoz','Male',23,'jeffreydawson@example.org','2023-03-23','4588269668',FALSE,'3740545127','Bank of America','Savings','SL65','HRB','IN','Not Applicable',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('99','Kevin Solis','Male',30,'cathy20@example.com','2023-03-24','6086370835',TRUE,'6560129869','Bank of America','Checking','M87','DS','LE','Simplified Employee Pension Plan',0);
INSERT INTO Employee(emp_ID,full_name,gender,age,email,join_date,contact_num,has_child,account_num,bank_name,acc_type,dept_ID,pos_ID,grade_ID,r_plan,retirement_amount) VALUES ('100','Angela Bishop','Female',25,'copelandallison@example.org','2023-02-10','8599339588',FALSE,'8602605839','U.S. Bank','Savings','SL65','MRA','JU','Traditional IRA pre-50',0);
